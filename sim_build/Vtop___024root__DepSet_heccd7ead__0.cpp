...
#endif
            VL_FATAL_MT("/work/rtl/tb_top.v", 15, "", "Input combinational region did not converge.");
        }
...
#endif
            VL_FATAL_MT("/work/rtl/tb_top.v", 15, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("/work/rtl/tb_top.v", 15, "", "Active region did not converge.");
            }
